<x-admin-layout>
    ...
    <div x-data="{dropdownMenu: false}" class="">
        ...
        <div x-show="dropdownMenu" class="pl-2 pr-6 text-gray-600">
            ...
            <div class="flex justify-end"><button class="bg-blue-400 text-white rounded-full mt-6 py-2 px-6">save</button></div>
        </div>
    </div>
